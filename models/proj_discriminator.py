...
class OASIS_Discriminator(nn.Module):
    def __init__(self, opt):
        ...
        self.channels = [3, 64, 64, 128, 128, 256, 256]
        ...
        for i in range(1, opt.num_res_blocks-2):
        ...
        self.body_up.append(residual_block_D(2*self.channels[2], 64, opt, 1))
    ...
    def forward(self, input):
        ...
        #decoder
        x = self.body_up[0](x)
        for i in range(1, len(self.body_down)-1):
